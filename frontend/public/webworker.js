...
self.onmessage = async (event) => {
    ...
    try {
        ...
        let fiber_meas = await self.get_lines(image, [38, 82], runInference) // TODO: args should come from UI
        // fiber_meas = Object.fromEntries(fiber_meas)
        // console.log(fiber_meas)
        fiber_meas
        self.postMessage({ fiber_meas, id });
    } catch (error) {
